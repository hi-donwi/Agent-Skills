---
source-skill: security-hardening
source-description: Hardens code against vulnerabilities. Use when handling user input, authentication, data storage, or external integrations. Use when building any feature that accepts untrusted data, manages user sessions, or interacts with third-party services.
---
...
These are prevention patterns, not a ranking. For the review-mode list, see `references/security-checklist.md`.
