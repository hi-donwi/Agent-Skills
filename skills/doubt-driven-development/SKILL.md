...
- **Do NOT add this skill to a persona's `skills:` frontmatter.** A persona that follows Step 3 would spawn another persona — "personas do not invoke other personas" is the orchestration anti-pattern this rule exists to prevent.
